...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className="bg-[#121212] border border-neutral-800 rounded-2xl overflow-hidden flex flex-col justify-between hover:border-neutral-700 transition">
      <div>
        ...
        <div className="p-4">
          ...
          <h3 className="text-white text-sm font-semibold truncate mt-1">
            {product.name}
          </h3>
